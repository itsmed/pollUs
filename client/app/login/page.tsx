    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white px-8 py-10 shadow-sm">
        <div className="mb-8 flex flex-col items-center gap-1 text-center">
          <Link to="/" className="mb-2 text-lg font-semibold text-zinc-900 hover:text-blue-600">
            PollUs
          </Link>
          <h1 className="text-xl font-semibold text-zinc-900">Sign in</h1>
          <p className="text-sm text-zinc-500">Continue with your Google or Apple account.</p>
        </div>

        <div className="flex flex-col gap-3">
          <a
            href={`${API_URL}/api/auth/google`}
            className="flex items-center justify-center gap-3 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-800 transition-colors hover:bg-zinc-50"
          >
            <GoogleIcon />
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-zinc-800"
          >
            <AppleIcon />
            Continue with Apple
          </a>
